...
public:
    ...
    CHIP_ERROR Init(TransportMgrBase * owner, Args &&... args)
    {
...
private:
    ...
    CHIP_ERROR InitImpl(TransportMgrBase * owner, InitArg && arg, Rest &&... rest)
    {
     ...
     */
    CHIP_ERROR InitImpl(TransportMgrBase * owner) { return CHIP_NO_ERROR; }
