...
CHIP_ERROR TypeInfo::DecodableType::Decode(TLV::TLVReader & reader, const ConcreteAttributePath & path)
{
    switch (path.mAttributeId)
    {
    case Attributes::LastMessageLQI::TypeInfo::GetAttributeId():
        ReturnErrorOnFailure(DataModel::Decode(reader, lastMessageLQI));
        break;
    case Attributes::LastMessageRSSI::TypeInfo::GetAttributeId():
        ReturnErrorOnFailure(DataModel::Decode(reader, lastMessageRSSI));
        break;
    case Attributes::GeneratedCommandList::TypeInfo::GetAttributeId():
        ReturnErrorOnFailure(DataModel::Decode(reader, generatedCommandList));
        break;
...
bool CommandIsFabricScoped(ClusterId aCluster, CommandId aCommand)
{
    ...
    case Clusters::ZigbeeDiagnostic::Id: {
        switch (aCommand)
        {
        default:
            return false;
