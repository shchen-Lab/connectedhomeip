...
void FanManager::PercentSettingWriteCallback(uint8_t aNewPercentSetting)
{
    ...
    {
        ChipLogProgress(NotSpecified, "FanManager::PercentSettingWriteCallback: %d", aNewPercentSetting);
...
void FanManager::SpeedSettingWriteCallback(uint8_t aNewSpeedSetting)
{
    ...
    {
        ChipLogProgress(NotSpecified, "FanManager::SpeedSettingWriteCallback: %d", aNewSpeedSetting);
...
{
    ChipLogProgress(NotSpecified, "FanManager::FanModeWriteCallback: %d", (uint8_t) aNewFanMode);
    switch (aNewFanMode)
    {
