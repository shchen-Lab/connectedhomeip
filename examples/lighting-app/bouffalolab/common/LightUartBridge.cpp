...
CHIP_ERROR InitLightUartBridge()
{
    ...
    sLightUartRxTaskHandle = xTaskCreateStatic(LightUartRxTask, "light_uart", MATTER_ARRAY_SIZE(sLightUartRxTaskStack),
                                               nullptr, kLightUartRxTaskPriority, sLightUartRxTaskStack,
                                               &sLightUartRxTaskStruct);
