...
lu_status_t EncodePayload(const ColorControl::Commands::MoveToHueAndSaturation::DecodableType & command, lu_payload_writer_t & writer);
...
lu_status_t EncodePayload(const ColorControl::Commands::MoveToColorTemperature::DecodableType & command, lu_payload_writer_t & writer);
...
lu_status_t EncodePayload(const ColorControl::Commands::EnhancedMoveToHueAndSaturation::DecodableType & command, lu_payload_writer_t & writer);
