...
lu_status_t EncodePayload(const ColorControl::Commands::MoveToSaturation::DecodableType & command,
                          lu_payload_writer_t & writer)
{
...
lu_status_t EncodePayload(const ColorControl::Commands::EnhancedMoveToHue::DecodableType & command,
                          lu_payload_writer_t & writer)
{
