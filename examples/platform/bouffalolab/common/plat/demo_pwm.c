...
void set_cold_temperature(void)
{
    ...
    bl_pwm_set_duty_ex(LED_C_PIN_PORT, 78,&threshold1, &threshold2);
    threshold1 = threshold2;
    bl_pwm_set_duty_ex(LED_W_PIN_PORT, 22,&threshold1, &threshold2);
    targetlevel=254;
    targettemp= 370;
}
